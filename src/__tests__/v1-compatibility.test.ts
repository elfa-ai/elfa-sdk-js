...
describe('V1CompatibilityLayer', () => {
  ...
  describe('legacy method signatures', () => {
    it('should handle getTopMentions with legacy parameters', async () => {
      ...
      const mockSDK = jest.spyOn(v1Client.getSDK(), 'getTopMentions')
    ...
    it('should handle getMentionsByKeywords with legacy parameters', async () => {
      ...
      const mockSDK = jest.spyOn(v1Client.getSDK(), 'getMentionsByKeywords')
        .mockResolvedValue(mockResponse);
    ...
    it('should handle getTrendingTokens with legacy parameters', async () => {
      ...
      const mockSDK = jest.spyOn(v1Client.getSDK(), 'getTrendingTokens')
        .mockResolvedValue(mockResponse);
  ...
  describe('utility methods', () => {
    it('should test connection', async () => {
      const mockSDK = jest.spyOn(v1Client.getSDK(), 'testConnection')
    ...
    it('should handle connection test failure', async () => {
      jest.spyOn(v1Client.getSDK(), 'testConnection')
  ...
  describe('ping method', () => {
    it('should transform ping response format', async () => {
      const mockSDK = jest.spyOn(v1Client.getSDK(), 'ping')
        .mockResolvedValue({
          success: true,
