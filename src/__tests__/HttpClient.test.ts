...
describe("HttpClient", () => {
  ...
  describe("request", () => {
    ...
    it("should throw error after max retries", async () => {
      ...
      await expect(
        httpClient.request({ url: "/test", retries: 1 }),
  ...
  describe("authentication headers", () => {
    it("should set Elfa auth header", () => {
      ...
      expect(mockAxiosInstance.defaults.headers.common["x-elfa-api-key"]).toBe(
        "test-api-key",
      );
    });
  ...
  describe("error handling", () => {
    ...
    it("should extract error message from various response formats", async () => {
      const testCases = [
        ...
        {
          data: { message: "Object with message" },
          expected: "Object with message",
        },
        { data: { error: "Object with error" }, expected: "Object with error" },
        {
          data: { detail: "Object with detail" },
          expected: "Object with detail",
        },
