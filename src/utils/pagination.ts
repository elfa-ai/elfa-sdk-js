...
export class PaginationHelper {
  ...
  public static async *iteratePages<TParams extends PagePaginationParams, TResponse>(
    fetchPage: (params: TParams) => Promise<{ data: TResponse[]; metadata: { page: number; pageSize: number; total: number } }>,
  ...
  public static async *iterateCursor<TParams extends CursorPaginationParams, TResponse>(
    fetchPage: (params: TParams) => Promise<{ data: TResponse[]; metadata: { cursor?: string; total?: number } }>,
    initialParams: TParams
  ): AsyncGenerator<TResponse[], void, unknown> {
  ...
  public static async collectAllPages<TParams extends PagePaginationParams, TResponse>(
    fetchPage: (params: TParams) => Promise<{ data: TResponse[]; metadata: { page: number; pageSize: number; total: number } }>,
    params: TParams,
    maxItems?: number
  ): Promise<TResponse[]> {
  ...
  public static async collectAllCursor<TParams extends CursorPaginationParams, TResponse>(
    fetchPage: (params: TParams) => Promise<{ data: TResponse[]; metadata: { cursor?: string; total?: number } }>,
    params: TParams,
    maxItems?: number
  ): Promise<TResponse[]> {
